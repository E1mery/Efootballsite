    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 sm:gap-4 my-2.5">
        ...
        <div className="flex-1 min-w-0 flex items-center justify-end gap-2 sm:gap-3 text-right">
          ...
          <div className="flex h-9 w-9 sm:h-11 sm:w-11 shrink-0 items-center justify-center rounded-xl bg-card border border-border p-1 font-black text-xs sm:text-sm text-white shadow-md overflow-hidden">
            {match.homePlayer ? (
              <img
        ...
        <div className="shrink-0 flex flex-col items-center justify-center px-1">
          {isLive || isFinished || isForfeit ? (
            <div className="flex items-center gap-1 rounded-xl bg-background border border-border px-2.5 sm:px-3.5 py-1 font-mono text-sm sm:text-lg font-black text-white shadow-inner">
